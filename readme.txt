...
Accetta pagamenti tramite buoni pasto per il tuo ecommerce grazie a Voucherly. Il modo migliore per usare i buoni pasto!
...
- Concludi il pagamento saldando la differenza con altre modalità di pagamento.
- L'ordine è completato. Non ti resta che attendere per riceverlo!
...
**Aumenta le vendite**
Aumenta le tue vendite attirando nuovi clienti interessati a spendere i propri buoni pasto.
...
== Changelog ==
= 1.1.1 =
* Fix display issue in WooCommerce (classic) for logged-in customers without saved payment methods
